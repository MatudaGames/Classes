...
//    pointsBack->setPositionY(visibleSize.height-25);
    pointsBack->setPosition(ccp(visibleSize.width+pointsBack->getContentSize().width+221,visibleSize.height-555));
...
//    }
	...
	*/
    ...
    //Check how far dwarf is from cave
    
	theDistanceFromStart = sqrtf((generatePoint.x - dwarf->getPositionX())*(generatePoint.x-dwarf->getPositionX()) +
